...
kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='ErjBTlwaOuJOQpodjNE0.AlWfIlsXTIJM7bmzvSVDia.PuFZfFDhuQTbq1OCxdMTEh9tVZmGfots0ZEnFt/zKn0=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Er2x7myEFiSPMu89iIYa.uMl8kSf8CYhDiUyd1w9SsG.3FHgIHa2xBj9XsByisI1p6NT/PMmRjqxJEe5h6w0tbc=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Er5Mtt3ILPvAxaVoYE51.ZFEHdQlbfxkm95LFtzYn0q.JMTC4m2z5wfyN8badd0ZuYI5ZsZKhL+Hrl7eSU1rwyU=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='ErJ8rbBrVwdB3LDZj6y0.fiIKg0XRBpH228JY7npzia.yfcr309Y/twqPj2oE0zBlzNvTm+ZXJjKLbGeDogJKyU=')
km.loginResult()
...
╚═════════════════════════
"""
adhi="uc2e8b426f6591045943eae5304e67c32"
...
Creator=["u687a46269a84797cca04df4a0e3232db"]
admin=["u687a46269a84797cca04df4a0e3232db","u1828b3a198c86976bda2406a1f53ceed","u68bc0588b4b1b628e6ec131956cbdd20","u5262fc2ac17c7321dd22e603d56f6c4a","ucdf7a10ea2c115728cf7995f4d9c8dd1","u1488a41b4c6b6cf876dbc8f2ecd3d920"]
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : Babang-adhi\nContact Me : 👉 line.me/ti/p/~jkp4678.",
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "uc2e8b426f6591045943eae5304e67c32"
                admin2 = "u687a46269a84797cca04df4a0e3232db"
                admin3 = "u1828b3a198c86976bda2406a1f53ceed"
              ...
              if msg.from_ in admin:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin Sudah Ditambahkan")
                        except:
                            pass
              ...
              if msg.from_ in admin:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin sudah Dihapus")
                        except:
                            pass
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "uc2e8b426f6591045943eae5304e67c32"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["Sita join","Join all"]:
		if msg.from_ in admin:
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"TBA1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"TBA2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"TBA3 Hadiir  \(ˆ▿ˆ)/")
		...
		if msg.from_ in admin:
            ...
            elif "TBkapten copy @" in msg.text:
                   print "[COPY] Ok"
            ...
            elif "TBA1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TBA1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "TBA2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TBA2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TBA3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TBA3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TBA4 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TBA4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line-cdn.net/Erx6Ph6DhuNxlfMabtzb.AhPgjPQeExZkbn9kdJiY2W.WQ13VHBa1bTenoyf7r6sfI+woUN8a5ydlEfsUm/BiFc="]
		...
		if msg.from_ in Creator:
              ...
              if msg.from_ in admin:
                ...
                kk.sendText(msg.to,"Katanya Admin kita Jomblo ya")
            ...
            elif msg.text in ["TBA1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TBA2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TBA3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TBA4 acc invite"]:
                if msg.from_ in admin:
